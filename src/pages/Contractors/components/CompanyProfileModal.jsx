                    ...
                    {editingVendor ? (
                        ...
                        <div>
                            ...
                            <div className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-2 flex flex-wrap gap-4 items-center">
                                ...
                                {activeVendor.portalCredentialEmailSentAt && <span className="px-2 py-0.5 rounded text-[9px] border bg-emerald-900/30 text-emerald-300 border-emerald-500/30"><i className="fas fa-envelope-circle-check mr-1"></i> Temp Password Emailed</span>}
                            ...
                            <>
                                <button type="button" onClick={onProvisionVendorPortalAccess} disabled={portalProvisioning} className="bg-emerald-600 hover:bg-emerald-500 disabled:opacity-60 text-white px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-colors shadow-lg shadow-emerald-600/20">
                                    {portalProvisioning
                                        ...
                                        : <><i className="fas fa-user-shield mr-1"></i> {activeVendor.portalUid ? 'Resend Access Email' : 'Provision & Email Login'}</>}
                                </button>
                                {activeVendor.email && (
