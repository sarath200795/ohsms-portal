                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        {visibleModules.slice(0, 3).map((module) => (
                            ...
                            >
                                ...
                                {module.entryBadge && (
                                    <div className={`mb-2 inline-flex items-center gap-2 rounded-full border px-2.5 py-1 text-[9px] font-bold uppercase tracking-[0.22em] ${module.entryBadgeClass || 'border-[rgba(249,115,22,0.25)] text-[var(--myth-ember)] bg-[rgba(255,247,237,0.8)]'}`}>
